             ...
             <div className="max-w-6xl mx-auto">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                 {MOCK_DATA.projectSummaries.map((project, index) => (
                   // Using index to ensure 3 cards fit nicely on desktop, with 2 extra on the next row.
...
// In a real project with modules, this export would be enough.
// For Babel standalone in the HTML file, we explicitly attach App to the window object
// for the second script block to find it. This is a workaround for the single-file setup.
window.App = App;
